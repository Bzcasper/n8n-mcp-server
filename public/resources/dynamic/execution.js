 ...
 */
export async function getExecutionResource(apiService, executionId) {
    try {
        ...
        throw new McpError(ErrorCode.InternalError, `Failed to retrieve execution (ID: ${executionId}): ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
}
/**
 ...
 */
export function getExecutionResourceTemplateUri() {
 ...
 */
export function getExecutionResourceTemplateMetadata() {
    return {
 ...
 */
export function extractExecutionIdFromUri(uri) {
