 ...
 */
export async function getWorkflowResource(apiService, workflowId) {
    try {
        ...
        throw new McpError(ErrorCode.InternalError, `Failed to retrieve workflow (ID: ${workflowId}): ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
}
/**
 ...
 */
export function getWorkflowResourceTemplateUri() {
 ...
 */
export function getWorkflowResourceTemplateMetadata() {
    return {
 ...
 */
export function extractWorkflowIdFromUri(uri) {
