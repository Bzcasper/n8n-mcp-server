...
export declare class N8nApiService {
     ...
     */
    getWorkflows(params?: Record<string, any>): Promise<Workflow[]>;
    /**
     ...
     */
    getWorkflow(id: string, params?: Record<string, any>): Promise<Workflow>;
    /**
     ...
     */
    getExecutions(params?: Record<string, any>): Promise<Execution[]>;
    /**
     ...
     */
    getExecution(id: string, params?: Record<string, any>): Promise<Execution>;
    /**
     * Delete an execution
     *
     * @param id Execution ID
     ...
     * @returns Updated workflow
     */
    transferWorkflow(id: string, destinationProjectId: string): Promise<Workflow>;
    /**
