...
export class ListUsersHandler extends BaseUserToolHandler {
    ...
    async execute(args) {
        return this.handleExecution(async () => {
            ...
            return this.formatSuccess(formattedUsers, `Found ${formattedUsers.length} user(s)`);
        }, args);
    }
}
/**
 ...
 */
export function getListUsersToolDefinition() {
    return {
        name: "n8n-users-list",
        description: "Retrieve a list of n8n users with optional filtering and pagination",
        inputSchema: {
            type: "object",
            properties: {
                limit: {
