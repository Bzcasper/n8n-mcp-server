    ...
    async execute(args) {
        return this.handleExecution(async (args) => {
            ...
            if (typeof destinationProjectId !== "string") {
                throw new N8nApiError("Parameter 'destinationProjectId' must be a string");
            }
            // Transfer the workflow
            const workflow = await this.apiService.transferWorkflow(id, destinationProjectId);
 ...
 */
export function getTransferWorkflowToolDefinition() {
    return {
