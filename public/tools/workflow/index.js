...
import { getTransferWorkflowToolDefinition, TransferWorkflowHandler, } from "./transfer.js";
...
import { getGetWorkflowTagsToolDefinition, GetWorkflowTagsHandler, getUpdateWorkflowTagsToolDefinition, UpdateWorkflowTagsHandler, } from "./tags.js";
import { getCreateAIMLWorkflowToolDefinition, AIMLWorkflowHandler, getCreateDataProcessingWorkflowToolDefinition, DataProcessingHandler, } from "./aiml.js";
import { getCreateScheduledWorkflowToolDefinition, SchedulingWorkflowHandler, getCreateMonitoringWorkflowToolDefinition, MonitoringWorkflowHandler, } from "./scheduling.js";
// Export handlers
 ...
 */
export async function setupWorkflowTools() {
    return [
