...
import { getCreateCredentialToolDefinition, CreateCredentialHandler, } from "./create.js";
import { getDeleteCredentialToolDefinition, DeleteCredentialHandler, } from "./delete.js";
import { getGetCredentialSchemaToolDefinition, GetCredentialSchemaHandler, } from "./schema.js";
import { getTransferCredentialToolDefinition, TransferCredentialHandler, } from "./transfer.js";
// Export handlers
 ...
 */
export async function setupCredentialTools() {
    return [
