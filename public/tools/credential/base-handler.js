/**
 * Base Credential Tool Handler
 *
 * This module provides a base handler for credential-related tools.
 *
 * @format
 */
 ...
 */
export class BaseCredentialToolHandler {
    constructor() {
    ...
    async handleExecution(handler, args) {
        try {
            ...
            return this.formatError(`Error executing credential tool: ${errorMessage}`);
        }
    }
}
