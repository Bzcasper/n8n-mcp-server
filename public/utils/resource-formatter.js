 ...
 */
export function formatWorkflowDetails(workflow) {
 ...
 */
export function formatExecutionStats(executions) {
 ...
 */
export function formatResourceUri(resourceType, id) {
    if (id) {
...
//# sourceMappingURL=resource-formatter.js.map