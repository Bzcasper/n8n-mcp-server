...
import { getDeleteWorkflowToolDefinition } from "../../../../src/tools/workflow/delete.js";
...
describe("Workflow Tools", () => {
  ...
  describe("getDeleteWorkflowToolDefinition", () => {
    it("should return the correct tool definition for n8n-workflow-delete", () => {
      const definition = getDeleteWorkflowToolDefinition();

      expect(definition.name).toBe("n8n-workflow-delete");
      expect(definition.description).toBe("Delete an n8n workflow by its ID");
      expect(definition.inputSchema).toBeDefined();
    ...
    it("should have the correct parameter schema structure", () => {
      ...
      expect(schema.properties?.id?.description).toBeTruthy();
    });
  });
});
