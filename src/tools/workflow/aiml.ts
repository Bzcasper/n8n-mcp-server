 ...
 */
export function getCreateAIMLWorkflowToolDefinition(): ToolDefinition {
  return {
    name: "n8n-workflow-create-aiml",
    description:
      "Create a comprehensive AI/ML training workflow with data processing, model training, and evaluation",
    inputSchema: {
      type: "object",
      properties: {
        name: {
 ...
 */
export function getCreateDataProcessingWorkflowToolDefinition(): ToolDefinition {
  return {
    name: "n8n-workflow-create-data-processing",
    description:
      "Create a data processing and transformation pipeline workflow",
    inputSchema: {
      type: "object",
      properties: {
        name: {
