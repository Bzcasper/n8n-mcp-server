 ...
 */
export async function getCredentialResource(
  ...
  try {
    ...
    console.error(
      `Error fetching credential resource (ID: ${credentialId}):`,
      error
    );
    ...
    throw new McpError(
      ...
      `Failed to retrieve credential (ID: ${credentialId}): ${
 ...
 */
export function getCredentialResourceTemplateUri(): string {
 ...
 */
export function getCredentialResourceTemplateMetadata(): Record<string, any> {
  return {
    uriTemplate: getCredentialResourceTemplateUri(),
    name: "n8n Credential Details",
    mimeType: "application/json",
    description:
      "Detailed information about a specific n8n credential including type and access permissions",
  };
}
 ...
 */
export function extractCredentialIdFromUri(uri: string): string | null {
